...
$ecms_config['db']['dbusername']='yuema';	//数据库用户名
$ecms_config['db']['dbpassword']='yuema123456';	//数据库密码
$ecms_config['db']['dbname']='yuema';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='yuema_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='HFkX1NslFhL7Uw7O07HP6hIPGSSSPfIY7oRt';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='crlyk';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='fdrcd';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='g4Wnwsp1JwFuRqKAn4Cny71P02fAuZVjWU9';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='gLhaLIDiO5pMZR1ksMtoGmaI38cGwKqpSk';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='ubpxeYXwECkcrfsabWRn0nS8Wp37MoD1v';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='GV03Nva8VhKuIIhnhnyaSFt8bqpqqyfA';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='KGktPNmaMnQRyQftCPnrrWQim4RkX5f';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'GxTeoNdcdaBsx7B11ITixuuVYgDlcCvo',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/about/\">关于跃马</a>&nbsp;|&nbsp;<a href=\"/news/\">新闻中心</a>&nbsp;|&nbsp;<a href=\"/products/\">产品中心</a>&nbsp;|&nbsp;<a href=\"/network/\">销售网络</a>&nbsp;|&nbsp;<a href=\"/contact/\">联系我们</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'liiCl4BeX3IVEqnEJmz1tbLrlztJdzS3ubgF',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'ouaqREbF9uQIF6UE10W6z3QuGG6b9PcCdd697pfOE4',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,special.field,newstime,titlepic,introduce,text,',
'qenter'=>',title,ftitle,special.field,newstime,titlepic,introduce,text,',
'listtempf'=>',title,ftitle,newstime,titlepic,introduce,',
'tempf'=>',title,ftitle,newstime,titlepic,introduce,text,',
'mustqenterf'=>',title,text,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,introduce,',
'cj'=>',title,ftitle,newstime,titlepic,',
'canaddf'=>',title,ftitle,newstime,titlepic,introduce,text,',
'caneditf'=>',title,ftitle,newstime,titlepic,introduce,text,',
'tbmainf'=>',title,titlepic,newstime,ftitle,introduce,',
'tbdataf'=>',text,',
'tobrf'=>',introduce,text,',
'dohtmlf'=>',ftitle,introduce,text,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',text,',
'ubbeditorf'=>',',
'pagef'=>'',
'smalltextf'=>',introduce,',
'filef'=>',',
'imgf'=>',titlepic,',
'flashf'=>',',
'linkfields'=>'|',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,titlepic,',
'qenter'=>',title,special.field,titlepic,',
'listtempf'=>',title,newstime,titlepic,',
'tempf'=>',title,newstime,titlepic,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,newstime,titlepic,',
'canaddf'=>',title,newstime,titlepic,',
'caneditf'=>',title,newstime,titlepic,',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,description,text,',
'qenter'=>',title,special.field,titlepic,newstime,description,text,',
'listtempf'=>',title,titlepic,newstime,description,',
'tempf'=>',title,titlepic,newstime,description,text,',
'mustqenterf'=>',title,newstime,description,text,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,titlepic,newstime,',
'canaddf'=>',title,titlepic,newstime,description,text,',
'caneditf'=>',title,titlepic,newstime,description,text,',
'tbmainf'=>',title,titlepic,newstime,description,',
'tbdataf'=>',text,',
'tobrf'=>',',
'dohtmlf'=>',description,text,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',text,',
'ubbeditorf'=>',',
