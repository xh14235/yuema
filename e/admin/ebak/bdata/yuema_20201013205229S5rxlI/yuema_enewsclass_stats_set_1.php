...
E_D("DROP TABLE IF EXISTS `yuema_enewsclass_stats_set`;");
E_C("CREATE TABLE `yuema_enewsclass_stats_set` (
...
E_D("replace into `yuema_enewsclass_stats_set` values('0','3600','0','20170227');");
