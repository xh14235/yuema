...
E_D("DROP TABLE IF EXISTS `yuema_enewsmoreport`;");
E_C("CREATE TABLE `yuema_enewsmoreport` (
...
E_D("replace into `yuema_enewsmoreport` values('1',0xe4b8bbe8aebfe997aee7abaf,'','','','','0','0','0','0','','0','0');");
