  ...
  <div class="content">
    <div class="container">
      <div class="content-left">
        <div class="content-name"><?=$class_r[$grbclassid][classname]?></div>
        <div class="content-nav">
          <p class="content-nav-item"><a href="/news/compony-news/" target="_blank">公司新闻</a></p>
          <p class="content-nav-item"><a href="/news/industry-news/" target="_blank">行业新闻</a></p>
        </div>
      ...
      <div class="content-right">
        ...
        <div class="content-detail">
          <div class="news-title2"><?=$ecms_gr[title]?></div>
          <div class="news-time2"><?=date('Y-m-d H:i:s',$ecms_gr[newstime])?></div>
          <div class="news-text"><?=$ecms_gr[text]?></div>
        </div>
      </div>
    </div>
  </div>
