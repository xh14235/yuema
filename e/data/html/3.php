...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>图片小图</td><td bgcolor='ffffff'><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
<textarea name="description" cols="60" rows="10" id="description"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[description]))?></textarea>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>正文</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("text",$ecmsfirstpost==1?"":stripSlashes($r[text]),"Default","","300","100%")?>
</td></tr></table>